package com.xl0e.hybris.messages;
...
public class Messages extends NLS {
    ...
    public static String WizardExternalProjectImportPage_refreshingWorkspace;
    public static String WizardProjectsImportPage_CreateCommonLibs;
    public static String WizardProjectsImportPage_fixExtension;
    ...
    public static String Show_extensions_presented_in_custom_folder_only;
    public static String Show_all_except_for_platform_ext_extensions;
    public static String Show_all_requied_extensions;

    public static String WorkingSet_Custom;
    public static String WorkingSet_Platform;
