...
public class AntCommandConsoleTracker implements IConsoleLineTracker {
    public static final String ANT_PROCESS_TYPE = "hybris.ant.AntCommand";
    public static final String EXT_TEMPLATE_ATTR = "hybris.extgen.ext_template";
    public static final String EXT_NAME_ATTR = "hybris.extgen.ext_name";
    public static final String EXT_PACKAGE_NAME_ATTR = "hybris.extgen.ext_package_name";
